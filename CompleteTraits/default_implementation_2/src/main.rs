...
trait Accomodation {
    fn get_description(&self) -> String{
        format!("This is a place for accomodation")
    }
...
fn main() {
    ...
    //Here we don't have any specific type of implementation regarding hotel for description 
    //It uses default implementation of the trait 
